...
public class TpchSchema extends AbstractSchema {
    ...
    private TpchSchema(String schemaName, Map<String, Table> tableMap) {
    ...
    public static final class Builder {
        ...
        public Builder addTable(TpchTable table) {
        ...
        public TpchSchema build() {
            return new TpchSchema(schemaName, tableMap);
        }
    }
}
